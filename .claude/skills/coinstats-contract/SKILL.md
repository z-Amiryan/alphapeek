...
CoinStats credit costs: detect ~5, token detail ~1, chart ~2, **wallet/balance 40**. The kind cache is what keeps repeated hovers of one address from re-burning 40 credits — never bypass `cached()`.
